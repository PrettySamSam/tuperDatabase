              ...
              //  resultTextView.setText(gson.toJson(response));
                ...
                if (params != null && !params.isEmpty()) {
                    ...
                    for (final Map.Entry<String, JsonElement> entry : params.entrySet()) {
                        ...
                        if(Key[count].equals("college")){
                            ParamValueLoc = Value[count];
                                    //helper.searchValue(Value[count]);
                        }
                        count++;
                    }
                }
                if(Key[0].equals("college")){

                    ParamValueLoc = help.searchValue(Value[0]);
                   help.close();
                    resultTextView.setText("intent : "+IntentName + " Key1: " + Key[0] + "Value1 : "+Value[0]+"Location: "+ParamValueLoc);
